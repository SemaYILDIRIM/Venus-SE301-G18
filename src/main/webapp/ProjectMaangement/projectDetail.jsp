        ...
        %>
         ...
         <div id="link4" class="prodetail">
             ...
             <table class="table" style="margin-left: 100px; margin-top: 50px;">
                        ...
                        <tr>
                            <td><a href=""><%=issue.getIssuesManager(request.getParameter("name")).get(i).getDescription()%></a></td>
                            <td><a href=""><%=issue.getIssuesManager(request.getParameter("name")).get(i).getSummary()%></a></td>
                            <td><a href=""><%=issue.getIssuesManager(request.getParameter("name")).get(i).getDescription()%></a></td>
                            <td><a href=""><%=issue.getIssuesManager(request.getParameter("name")).get(i).getCreationDate()%></a></td>
                            <td><a href=""><%=issue.getIssuesManager(request.getParameter("name")).get(i).getPriority()%></a></td>
                            <td><a href=""><%=issue.getIssuesManager(request.getParameter("name")).get(i).getDueDate()%></a></td>
        ...
        %>
         ...
         <div id="link3" class="prodetail">
             ...
             <table class="table" style="margin-left: 100px; margin-top: 50px;">
                        ...
                        <tr>
                            <td><a href=""><%=issue.getIssuesAssignee(g,request.getParameter("name")).get(i).getDescription()%></a></td>
                            <td><a href=""><%=issue.getIssuesAssignee(g,request.getParameter("name")).get(i).getSummary()%></a></td>
                            <td><a href=""><%=issue.getIssuesAssignee(g,request.getParameter("name")).get(i).getDescription()%></a></td>
                            <td><a href=""><%=issue.getIssuesAssignee(g,request.getParameter("name")).get(i).getCreationDate()%></a></td>
                            <td><a href=""><%=issue.getIssuesAssignee(g,request.getParameter("name")).get(i).getPriority()%></a></td>
                            <td><a href=""><%=issue.getIssuesAssignee(g,request.getParameter("name")).get(i).getDueDate()%></a></td>
